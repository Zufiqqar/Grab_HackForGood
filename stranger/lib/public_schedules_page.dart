          ...
          children: [
            ...
            Container(
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center,
                children:[
                    Text("Search results for schedules are within 2km",
                    style: secondaryTextStyle(size: Font().small.toInt(), color: Colors.black),
                    maxLines: 3,
                    overflow: TextOverflow.ellipsis,
                    textAlign: TextAlign.center,
            ...
            Row(
              ...
              children: [
                Container(
                  ...
                  child: Text("Can't find any schedule that you want? Host your own schedule!",
                    style: boldTextStyle(size: Font().small.toInt(), color: Colors.black),
                    maxLines: 3,
                    overflow: TextOverflow.ellipsis,
                    textAlign: TextAlign.center,
                ...
                SizedBox(
                  ...
                  child: MaterialButton(
                    ...
                    shape: RoundedRectangleBorder(borderRadius: new BorderRadius.circular(40.0),
                        side: BorderSide(color: Col().darkerpurple, width: 1)),
                    color: Col().darkerpurple,
                    onPressed: () => {
